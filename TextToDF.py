...
class TextDF:
    ...
    def count_by_week(self):
        ...
        print(
            f"This week ({current_week_period.start_time.strftime('%d/%m/%Y')} - {current_week_period.end_time.strftime('%d/%m/%Y')}): {current_week_count} messages")
...
print(find_end_of_week(pd.Timestamp(year = 2025, month= 2, day= 27)))
